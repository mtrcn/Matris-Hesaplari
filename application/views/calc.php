...
<table style="width: 100%;">
	...
	<tr>
		...
		<div style="text-align: center; margin-top:5px;">
			<input class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" type="button" value="Hesapla" onClick="calculate()"> 
			<input class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" type="button" value="Kaydet" onClick="showSaveDialog()">
			<input class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" type="button" value="Projelerim" onClick="showLoadDialog()">
			<a href="<?php echo base_url(); ?>user/logout" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="padding:7px;">Oturumu Kapat</a>
		</td>
	</tr>
</table>
</div>
<div class="ui-corner-all wrapper" style="text-align:center;">
...
<div id="help-message" title="Yardım" style="display: none; font-size:11px;">
	<p>
		...
		Bir matrisi işleme sokmadan önce tersini, transpozesini veya determinantını almak istiyorsanız çalışma sayfası 
